...
// Пример 1
// Если переменная num = 5, то выведите 'true' в console.log, иначе выведите 'false'.
//let num = 5;
//if(num === 5){
//     console.log(true);
// }else{
...
len = str.length;
if (num > 0) {
	console.log("Полученное значение - целое положительно число, длина которого " + len + " знака.");
} else {
	console.log("Полученное значение - целое отрицательное число, длина которого " + (len - 1) + " знака.");
}
